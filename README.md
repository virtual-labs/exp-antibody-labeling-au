...
<b> Experiment|     <b> Antibody Labeling with HRP

### About the Experiment 

Based on the principle that an antibody specifically reacts with its corresponding antigen, several procedures have been developed in which Antibodies or antigens labeled with appropriate indicators.HRP is one of the mainly used label.
